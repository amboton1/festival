      ...
      <main>
        ...
        <section id="about" className={styles.content}>
          <div className={styles.program}>
            ...
            <div>
              Welcome Spring Festival je mjesto na kojem se priroda i ljudi vole
            </div>
            <div>
              <h5 style={{ margin: '0' }}>BUDI PROMJENA</h5>
            ...
            <div style={{ paddingBottom: '66px' }}>
              <h5>“AFTER FUN STILL GREEN”</h5>
            </div>
          </div>
          {/* <img className={styles.image} src="/fest2.jpeg" alt="About" /> */}
        </section>
        <section id="category" className={styles.content}>
          {/* <img className={styles.image} src="/fest3.jpg" alt="Category" /> */}
          <div class={styles.contentWraper}>
            <div className={styles.contentTitle}>PROGRAM FESTIVALA</div>
          ...
          <div className={styles.location}>
            <div className={styles.socials}>
              ...
              <div className={styles.contact}>
                <span>KONTAKT</span>
                <a className={styles.mail} href="mailto:prirodazasve@gmail.com">
            ...
            <div className={styles.locationWrapper}>
              <span>LOKACIJA</span>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d5562.272661197162!2d15.978507!3d45.808528!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x4765d6f924799ff7%3A0x26df5e73a0365859!2sPark+Josipa+Jurja+Strossmayera%2C+10000%2C+Zagreb%2C+Croatia!5e0!3m2!1sen!2shr!4v1489505173833"
                width="450"
                height="250"
                frameborder="0"
                style={{ width: '100%' }}
